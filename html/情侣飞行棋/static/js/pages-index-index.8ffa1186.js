    ...
    "001b": function (e, t, i) {
        ...
        var a = {
            ...
            return i("v-uni-view", {staticClass: "body"}, [i("u-navbar", {
                staticClass: "navbar",
                attrs: {placeholder: !0, title: "情侣飞行棋（©猫耳网络） " + e.v, titleStyle: {color: "#fff"}},
                on: {
                ...
                attrs: {slot: "right", name: "setting", size: "20", color: "#fff"},
                slot: "right"
            })], 1), i("v-uni-view", {staticClass: "bottom-bg"}), i("v-uni-view", {staticClass: "main"}, e._l(e.list, (function (t) {
                return i("v-uni-view", {
                    key: t.id,
                    staticClass: "btn",
                ...
                }, [i("v-uni-view", {staticClass: "my-text"}, [e._v(e._s(t.text))]), t.hot ? i("v-uni-view", {staticClass: "hot"}, [e._v("HOT")]) : e._e(), t.lockFlag && !e.lockVip ? i("u-icon", {
                    attrs: {
                        name: "lock",
                        color: "#919398",
                        size: "16"
                ...
                attrs: {show: e.setShow, mode: "center", customStyle: "backgroundColor:transparent"},
                on: {
                    close: function (t) {
                        arguments[0] = t = e.$handleEvent(t), e.setShow = !1
                    }
                }
            }, [i("v-uni-view", [i("v-uni-view", {staticClass: "tip-box"}, [i("v-uni-view", {staticClass: "tip-text"}, [e._v("语音提示")]), i("u-switch", {
                attrs: {
                    value: e.voiceOpen,
                    activeColor: "#e47470"
                }, on: {
            ...
            }, [i("v-uni-view", {staticClass: "tip-text"}, [e._v("识别码")]), i("u-icon", {
                attrs: {
                    name: "arrow-right",
                ...
                attrs: {show: e.customShow, mode: "center", customStyle: "backgroundColor:transparent"},
                on: {
                    close: function (t) {
                ...
                return i("v-uni-view", {
                    key: t.id, staticClass: "tip-box", on: {
                        click: function (i) {
                            arguments[0] = i = e.$handleEvent(i), e.goChess(t.id)
                        }
                    }
                }, [i("v-uni-view", {staticClass: "tip-text"}, [e._v(e._s(t.title))]), i("u-icon", {
                    attrs: {
                        name: "arrow-right",
                        color: "#fff"
                    }
            ...
            }, [i("v-uni-view", {staticClass: "tip-text"}, [i("u-icon", {
                attrs: {
                    color: "#fff",
                    labelColor: "#fff",
                    name: "plus",
        ...
        (function (e) {
            ...
            var a = function (i, a) {
                ...
                a && Object.deepExtend(s, a), s.tmp.obj = {
                    ...
                    if (this.radius = (s.particles.size.random ? Math.random() : 1) * s.particles.size.value, s.particles.size.anim.enable && (this.size_status = !1, this.vs = s.particles.size.anim.speed / 100, s.particles.size.anim.sync || (this.vs = this.vs * Math.random())), this.x = a ? a.x : Math.random() * s.canvas.w, this.y = a ? a.y : Math.random() * s.canvas.h, this.x > s.canvas.w - 2 * this.radius ? this.x = this.x - this.radius : this.x < 2 * this.radius && (this.x = this.x + this.radius), this.y > s.canvas.h - 2 * this.radius ? this.y = this.y - this.radius : this.y < 2 * this.radius && (this.y = this.y + this.radius), s.particles.move.bounce && s.fn.vendors.checkOverlap(this, a), this.color = {}, "object" == t(e.value)) if (e.value instanceof Array) {
                    ...
                    var e = this;
                    if (void 0 != e.radius_bubble) var t = e.radius_bubble; else t = e.radius;
                    if (void 0 != e.opacity_bubble) var i = e.opacity_bubble; else i = e.opacity;
                    if (e.color.rgb) var a = "rgba(" + e.color.rgb.r + "," + e.color.rgb.g + "," + e.color.rgb.b + "," + i + ")"; else a = "hsla(" + e.color.hsl.h + "," + e.color.hsl.s + "%," + e.color.hsl.l + "%," + i + ")";
                    switch (s.canvas.ctx.fillStyle = a, s.canvas.ctx.beginPath(), e.shape) {
                        ...
                        case"star":
                            ...
                            break;
                        case"image":
                            if ("svg" == s.tmp.img_type) var n = e.img.obj; else n = s.tmp.img_obj;
                            n && function () {
                    ...
                    var i = e.x - t.x, a = e.y - t.y, n = Math.sqrt(i * i + a * a);
                    ...
                    var i = e.x - t.x, a = e.y - t.y, n = Math.sqrt(i * i + a * a), r = e.radius + t.radius;
                    ...
                    if (s.interactivity.events.onhover.enable && r("bubble", s.interactivity.events.onhover.mode)) {
                        var t = function () {
                            ...
                            }, i = e.x - s.interactivity.mouse.pos_x, a = e.y - s.interactivity.mouse.pos_y,
                            n = Math.sqrt(i * i + a * a), o = 1 - n / s.interactivity.modes.bubble.distance;
                        if (n <= s.interactivity.modes.bubble.distance) {
                            if (o >= 0 && "mousemove" == s.interactivity.status) {
                                ...
                                if (s.interactivity.modes.bubble.opacity != s.particles.opacity.value) if (s.interactivity.modes.bubble.opacity > s.particles.opacity.value) {
                        ...
                        var d = function (t, i, a, r, o) {
                            if (t != i) if (s.tmp.bubble_duration_end) {
                                if (void 0 != a) {
                                    var c = r - p * (r - t) / s.interactivity.modes.bubble.duration, l = t - c;
                                    d = t + l, "size" == o && (e.radius_bubble = d), "opacity" == o && (e.opacity_bubble = d)
                                }
                            } else if (n <= s.interactivity.modes.bubble.distance) {
                                if (void 0 != a) var u = a; else u = r;
                                if (u != t) {
                        ...
                        if (s.tmp.bubble_clicking) {
                            ...
                            var p = ((new Date).getTime() - s.interactivity.mouse.click_time) / 1e3;
                    ...
                    if (s.interactivity.events.onhover.enable && r("repulse", s.interactivity.events.onhover.mode) && "mousemove" == s.interactivity.status) {
                        var t = e.x - s.interactivity.mouse.pos_x, i = e.y - s.interactivity.mouse.pos_y,
                            a = Math.sqrt(t * t + i * i), n = {x: t / a, y: i / a},
                            o = s.interactivity.modes.repulse.distance, c = function (e, t, i) {
                    ...
                    } else if (s.interactivity.events.onclick.enable && r("repulse", s.interactivity.events.onclick.mode)) if (s.tmp.repulse_finish || (s.tmp.repulse_count++, s.tmp.repulse_count == s.particles.array.length && (s.tmp.repulse_finish = !0)), s.tmp.repulse_clicking) {
                        o = Math.pow(s.interactivity.modes.repulse.distance / 6, 3);
                        var u = s.interactivity.mouse.click_pos_x - e.x, d = s.interactivity.mouse.click_pos_y - e.y,
                            p = u * u + d * d, f = -o / p * 1;
                        p <= o && function () {
                    ...
                    for (var i = 0; i < s.particles.array.length; i++) {
                        var a = s.particles.array[i], n = e.x - a.x, r = e.y - a.y, o = Math.sqrt(n * n + r * r);
                    ...
                    var t = s.tmp.source_svg, i = t.replace(/#([0-9A-F]{3,6})/gi, (function (t, i, a, n) {
                        ...
                        n = window.URL || window.webkitURL || window, r = n.createObjectURL(a), o = new Image;
                    ...
                    var o = n * r, s = n / r, c = 180 * (s - 2) / s, l = Math.PI - Math.PI * c / 180;
                    ...
                    if (s.tmp.img_error = void 0, "" != s.particles.shape.image.src) if ("svg" == t) {
            ...
            Object.deepExtend = function (e, t) {
                ...
                var i = document.getElementById(e), n = i.getElementsByClassName("particles-js-canvas-el");
            ...
            var o = {
                particles: {
                    ...
                    opacity: {value: .5, random: !0, anim: {enable: !1, speed: 1, opacity_min: .1, sync: !1}},
                    size: {value: 10, random: !0, anim: {enable: !1, speed: 40, size_min: .1, sync: !1}},
                    line_linked: {enable: !1, distance: 500, color: "#ffffff", opacity: .4, width: 2},
                    move: {
                        enable: !0,
                        speed: 6,
                        direction: "bottom",
                ...
                interactivity: {
                    ...
                    modes: {
                        grab: {distance: 400, line_linked: {opacity: .5}},
                        bubble: {distance: 400, size: 4, duration: .3, opacity: 1, speed: 3},
                        repulse: {distance: 200, duration: .4},
                        push: {particles_nb: 4},
                        remove: {particles_nb: 2}
                    }
        ...
        "use strict";
        var a = i("0821"), n = i.n(a);
        n.a
    }, "1dfe": function (e, t, i) {
        "use strict";
        i.r(t);
        var a = i("5de6"), n = i("27a0");
        ...
        Object.defineProperty(t, "__esModule", {value: !0}), t.default = function (e, t) {
            ...
            if (null === e || "object" !== (0, a.default)(e) && "function" !== typeof e) return {default: e};
            var i = n(t);
        ...
        "use strict";
        i("7a82"), Object.defineProperty(t, "__esModule", {value: !0}), t.default = void 0, i("a9e3");
        var a = {
            props: {
                ...
                confirmText: {type: String, default: uni.$u.props.modal.confirmText},
                cancelText: {type: String, default: uni.$u.props.modal.cancelText},
                showConfirmButton: {type: Boolean, default: uni.$u.props.modal.showConfirmButton},
                showCancelButton: {type: Boolean, default: uni.$u.props.modal.showCancelButton},
                confirmColor: {type: String, default: uni.$u.props.modal.confirmColor},
                cancelColor: {type: String, default: uni.$u.props.modal.cancelColor},
                buttonReverse: {type: Boolean, default: uni.$u.props.modal.buttonReverse},
                zoom: {type: Boolean, default: uni.$u.props.modal.zoom},
                asyncClose: {type: Boolean, default: uni.$u.props.modal.asyncClose},
                closeOnClickOverlay: {type: Boolean, default: uni.$u.props.modal.closeOnClickOverlay},
                negativeTop: {type: [String, Number], default: uni.$u.props.modal.negativeTop},
                width: {type: [String, Number], default: uni.$u.props.modal.width},
                confirmButtonShape: {type: String, default: uni.$u.props.modal.confirmButtonShape}
            }
        };
        t.default = a
    }, "50ff": function (e, t, i) {
        ...
        var a = function () {
            var e = this, t = e.$createElement, i = e._self._c || t;
            return i("v-uni-view", {staticClass: "u-code-input"}, [e._l(e.codeLength, (function (t, a) {
                return i("v-uni-view", {
                    key: a,
                    staticClass: "u-code-input__item",
                    style: [e.itemStyle(a)]
                }, [e.dot && e.codeArray.length > a ? i("v-uni-view", {staticClass: "u-code-input__item__dot"}) : i("v-uni-text", {
                    style: {
        ...
        Object.defineProperty(t, "__esModule", {value: !0}), t.default = void 0, i("a9e3"), i("99af"), i("ac1f"), i("5319");
        var n = a(i("ea24")), r = {
            name: "u-code-input", mixins: [uni.$u.mpMixin, uni.$u.mixin, n.default], data: function () {
                ...
                codeLength: function () {
                    ...
                    var e = this;
                    return function (t) {
                        var i = uni.$u.addUnit, a = {width: i(e.size), height: i(e.size)};
                        return "box" === e.mode && (a.border = "".concat(e.hairline ? .5 : 1, "px solid ").concat(e.borderColor), 0 === uni.$u.getPx(e.space) && (0 === t && (a.borderTopLeftRadius = "3px", a.borderBottomLeftRadius = "3px"), t === e.codeLength.length - 1 && (a.borderTopRightRadius = "3px", a.borderBottomRightRadius = "3px"), t !== e.codeLength.length - 1 && (a.borderRight = "none"))), t !== e.codeLength.length - 1 ? a.marginRight = i(e.space) : a.marginRight = 0, a
                    }
                }, codeArray: function () {
                ...
                inputHandler: function (e) {
                    ...
                    })), this.$emit("change", i), this.$emit("input", i), String(i).length >= Number(this.maxlength) && this.$emit("finish", i)
                }
            }
        };
        t.default = r
        ...
        var a = {uPopup: i("6c36").default, uLine: i("985f").default, uLoadingIcon: i("cf6a").default},
            n = function () {
                var e = this, t = e.$createElement, i = e._self._c || t;
                return i("u-popup", {
                    attrs: {
                ...
                }, [e.title ? i("v-uni-text", {staticClass: "u-modal__title"}, [e._v(e._s(e.title))]) : e._e(), i("v-uni-view", {
                    staticClass: "u-modal__content",
                    style: {paddingTop: (e.title ? 12 : 25) + "px"}
                }, [e._t("default", [i("v-uni-text", {staticClass: "u-modal__content__text"}, [e._v(e._s(e.content))])])], 2), e.$slots.confirmButton ? i("v-uni-view", {staticClass: "u-modal__button-group--confirm-button"}, [e._t("confirmButton")], 2) : [i("u-line"), i("v-uni-view", {
                    staticClass: "u-modal__button-group",
                    style: {flexDirection: e.buttonReverse ? "row-reverse" : "row"}
                    ...
                    attrs: {"hover-stay-time": 150, "hover-class": "u-modal__button-group__wrapper--hover"},
                    on: {
                        click: function (t) {
                ...
                }, [e._v(e._s(e.cancelText))])], 1) : e._e(), e.showConfirmButton && e.showCancelButton ? i("u-line", {attrs: {direction: "column"}}) : e._e(), e.showConfirmButton ? i("v-uni-view", {
        ...
        var n = a(i("4be7")), r = {
            name: "u-modal", mixins: [uni.$u.mpMixin, uni.$u.mixin, n.default], data: function () {
                return {loading: !1}
            }, watch: {
                show: function (e) {
        ...
        var a = {uLoadingIcon: i("cf6a").default}, n = function () {
            var e = this, t = e.$createElement, i = e._self._c || t;
            return i("v-uni-view", {
        ...
        i("7a82");
        var a = i("4ea4").default;
        Object.defineProperty(t, "__esModule", {value: !0}), t.default = void 0, i("a9e3");
        var n = a(i("d50e")), r = {
            name: "u-switch",
        ...
        i("7a82");
        var a = i("4ea4").default;
        Object.defineProperty(t, "__esModule", {value: !0}), t.default = void 0, i("d3b7"), i("c740");
        var n = a(i("5530")), r = a(i("36cd")), o = i("26cb"), s = {
            components: {
            ...
            computed: (0, n.default)({}, (0, o.mapState)(["voiceOpen", "userCustomList", "soundFlag", "identificationCode", "lockVip"])),
            methods: (0, n.default)((0, n.default)({}, (0, o.mapMutations)(["setVoiceOpen", "setSoundFlag", "setLockVip"])), {}, {
                lockVipClick: function () {
                    this.lockVip ? uni.showToast({title: "您已永久激活", icon: "none"}) : this.pswShow = !0
                }, finish: function (e) {
                    var t = this;
                    ...
                    var i = setTimeout((function () {
                        ...
                        a ? (uni.hideLoading(), t.pswShow = !1, t.setShow = !1, uni.showModal({
                            ...
                            title: "验证失败,请联系创作者QQ:3152374097（不考川大不改名）购买识别码或更改识别码",
                            icon: "none"
                        }))
                    }), 1e3)
                }, weGo: function (e) {
                    if (this.lockVip || !e.lockFlag) {
                        if (!this.stop) if (this.stop = !0, e.id != this.list[this.list.length - 1].id) {
                    ...
                    uni.reLaunch({url: "/pagesA/chess/chess?customId=".concat(e)})
                }, onNew: function () {
        ...
        var a = {
            props: {
                ...
                activeColor: {type: String, default: uni.$u.props.switch.activeColor},
                inactiveColor: {type: String, default: uni.$u.props.switch.inactiveColor},
                value: {type: [Boolean, String, Number], default: uni.$u.props.switch.value},
                activeValue: {type: [String, Number, Boolean], default: uni.$u.props.switch.activeValue},
                inactiveValue: {type: [String, Number, Boolean], default: uni.$u.props.switch.inactiveValue},
                asyncChange: {type: Boolean, default: uni.$u.props.switch.asyncChange},
        ...
        a(i("066c"));
        var n = {
            name: "akira-particles", props: ["particlestyle"], mounted: function () {
        ...
        var a = {
            props: {
                adjustPosition: {type: Boolean, default: uni.$u.props.codeInput.adjustPosition},
                maxlength: {type: [String, Number], default: uni.$u.props.codeInput.maxlength},
                ...
                space: {type: [String, Number], default: uni.$u.props.codeInput.space},
                value: {type: [String, Number], default: uni.$u.props.codeInput.value},
                ...
                fontSize: {type: [String, Number], default: uni.$u.props.codeInput.fontSize},
                size: {type: [String, Number], default: uni.$u.props.codeInput.size},
                disabledKeyboard: {type: Boolean, default: uni.$u.props.codeInput.disabledKeyboard},
                borderColor: {type: String, default: uni.$u.props.codeInput.borderColor},
                disabledDot: {type: Boolean, default: uni.$u.props.codeInput.disabledDot}
            }
        };
        t.default = a
    }, f3b1: function (e, t, i) {
