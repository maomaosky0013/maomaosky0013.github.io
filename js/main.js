...
$(function() {
  var bookmark = {
    data: [{
      name: '川大官网',
      link: 'https://chuanda521.github.io',
      box_shadow: '#00A0E9',
      icon: 'img/2.jpg',
    },{
      name: '光 遇',
      link: 'https://www.123pan.com/s/A0xSVv-kmJud.html',
      box_shadow: '#F2584A',
      icon: './img（2）/guangyu.png',
    },{
      name: '酷安',
      ...
      name: 'Hello Kitty',
      link: './html/hello/index.html',
      box_shadow: '#00A0E9',
      icon: './html/hello/1.png',
    },{
      name: '情侣飞行棋',
      link: './html/情侣飞行棋/index.html',
      box_shadow: '#AC6E2F',
      icon: './img（2）/logo.png',
    },{
      name: 'Win-12 概念版',
      link: 'https://win12maomaosky.github.io',
      box_shadow: '#3279ea',
      icon: './img（2）/win12.svg',
    },]
  }
